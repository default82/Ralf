...
CONTAINER_NAME=ralf-lxc
CTID_VAR=RALF_LXC_CTID
IP_VAR=RALF_LXC_IPV4
GATEWAY_VAR=RALF_LXC_GW
HOSTNAME_VAR=RALF_LXC_FQDN
CPU_VAR=RALF_LXC_CPUS
MEM_VAR=RALF_LXC_MEMORY
DISK_VAR=RALF_LXC_DISK
