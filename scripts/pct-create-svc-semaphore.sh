...
CONTAINER_NAME=svc-semaphore
CTID_VAR=SEMAPHORE_CTID
IP_VAR=SEMAPHORE_IPV4
GATEWAY_VAR=SEMAPHORE_GW
HOSTNAME_VAR=SEMAPHORE_FQDN
CPU_VAR=SEMAPHORE_CPUS
MEM_VAR=SEMAPHORE_MEMORY
DISK_VAR=SEMAPHORE_DISK
