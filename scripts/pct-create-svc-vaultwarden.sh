...
CONTAINER_NAME=svc-vaultwarden
CTID_VAR=VAULTWARDEN_CTID
IP_VAR=VAULTWARDEN_IPV4
GATEWAY_VAR=VAULTWARDEN_GW
HOSTNAME_VAR=VAULTWARDEN_FQDN
CPU_VAR=VAULTWARDEN_CPUS
MEM_VAR=VAULTWARDEN_MEMORY
DISK_VAR=VAULTWARDEN_DISK
...
DEFAULT_MEMORY=${DEFAULT_MEMORY:-1536}
DEFAULT_DISK=${DEFAULT_DISK:-4G}
