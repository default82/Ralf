...
CONTAINER_NAME=svc-foreman
CTID_VAR=FOREMAN_CTID
IP_VAR=FOREMAN_IPV4
GATEWAY_VAR=FOREMAN_GW
HOSTNAME_VAR=FOREMAN_FQDN
CPU_VAR=FOREMAN_CPUS
MEM_VAR=FOREMAN_MEMORY
DISK_VAR=FOREMAN_DISK
...
DEFAULT_MEMORY=${DEFAULT_MEMORY:-6144}
DEFAULT_DISK=${DEFAULT_DISK:-64G}
