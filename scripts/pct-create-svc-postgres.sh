...
CTID_VAR=POSTGRES_CTID
IP_VAR=POSTGRES_IPV4
GATEWAY_VAR=POSTGRES_GW
HOSTNAME_VAR=POSTGRES_FQDN
CPU_VAR=POSTGRES_CPUS
MEM_VAR=POSTGRES_MEMORY
DISK_VAR=POSTGRES_DISK
...
DEFAULT_MEMORY=${DEFAULT_MEMORY:-8192}
DEFAULT_DISK=${DEFAULT_DISK:-128G}
