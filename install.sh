...
Optionen:
  --repo-url <url>     Git-URL des Ralf-Repositories (Standard: https://github.com/default82/Ralf.git, wird bei GitHub automatisch auf SSH umgeschrieben)
